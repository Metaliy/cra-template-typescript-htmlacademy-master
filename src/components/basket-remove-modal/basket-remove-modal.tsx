  ...
  return (
    <div className="modal is-active">
      <div className="modal__wrapper">
        <div className="modal__overlay" data-testid={'overaly'} onClick={() => setRemoveCameraModalOpenStatusHandler(false)}></div>
        <div className="modal__content">
          ...
          <div className="modal__buttons">
            <button className="btn btn--purple modal__btn modal__btn--half-width" type="button" data-testid={'confirm-button'} onClick={() => {
              dispatch(removedItemConfirm(camera.id));
              setRemoveCameraModalOpenStatusHandler(false);
            }}
            >Удалить
            </button>
            <Link className="btn btn--transparent modal__btn modal__btn--half-width" data-testid={'continue-button'} to='' onClick={() => setRemoveCameraModalOpenStatusHandler(false)}>Продолжить покупки
            </Link>
          </div>
          <button className="cross-btn" type="button" aria-label="Закрыть попап" data-testid={'cross-button'} onClick={() => setRemoveCameraModalOpenStatusHandler(false)}>
