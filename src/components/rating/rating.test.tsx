...
describe('Rating component', () => {
  it('should render "Product card rating component"', () => {
    renderFakeApp(<Rating rating={fakeCamera.rating} maxRating={fakeMaxStarRating} reviewCount={fakeCamera.reviewCount} />, {});
  ...
  it('should render "Review card rating component"', () => {
    renderFakeApp(<Rating rating={fakeCamera.rating} maxRating={fakeMaxStarRating} isReview />, {});
