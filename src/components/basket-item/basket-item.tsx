  ...
  return (
    <li className="basket-item">
      ...
      <div className="quantity">
        ...
        <button className="btn-icon btn-icon--next" aria-label="увеличить количество товара" onClick={() => dispatch(addedItemsCounters({id: id, isPlus: true}))} disabled={camerasCount >= 99}>
          <svg width="7" height="12" aria-hidden="true">
            <use xlinkHref="#icon-arrow"></use>
          </svg>
        </button>
