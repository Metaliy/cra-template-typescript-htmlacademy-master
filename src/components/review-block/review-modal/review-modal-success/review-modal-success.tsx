      ...
      <div className="modal__wrapper">
        ...
        <div className="modal__content" data-testid="review-modal-success">
          ...
          <div className="modal__buttons">
            <button className="btn btn--purple modal__btn modal__btn--fit-width" type="button" onClick={() => dispatch(reviewModal(false))} data-testid='back-to-button' >Вернуться к покупкам
            </button>
          </div>
